...
const HomePageComponent = () => {
    ...
    useEffect(() => {
        ...
        const phrasesHome = ["Tech Cognoscenti",
          "Cinephile",
          "Biblophile"];
        const phrasesWork = [
          "Fullstack Developer",
        ...
        interval = setInterval(() => {
          ...
          promptHome!.style.setProperty("--chwidth", `${currHomePhrase.length + 1}`);
          promptWork!.textContent = currWorkPhrase;
          promptWork!.style.setProperty("--chwidth", `${currWorkPhrase.length + 1}`);
        }, 4500);
      }, []);
   ...
   <> 
    ...
    <div className={`${homeStyles.homeHeaderContainer}`}>
      ...
      <h1 className={homeStyles.headingName}>
        I&apos;m<strong className={homeStyles.mainName}> Yagzan Manjunaath</strong>
      </h1>
    </div>
    <div className={`${homeStyles.homeHeaderContainer}`}>
      <Image
